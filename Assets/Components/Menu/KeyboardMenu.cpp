...
RType::KeyboardMenu::KeyboardMenu(KapEngine::SceneManagement::Scene &_scene) : Menu(_scene) {}
...
void RType::KeyboardMenu::goToMenu(const std::string &name) {
    auto objs = scene.getGameObjects("Canvas" + name);
    auto objCurr = scene.getGameObjects("CanvasKeyboardMenu");
