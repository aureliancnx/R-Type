 ...
 * @return void
 */
void initShipAnimation(const std::shared_ptr<KapEngine::GameObject>& shipObj) {
...
void singleScene(KapEngine::KapEngine *engine, KapEngine::RType::MenuManager &manager) {
    ...
    try {
        ...
        auto canvas = KapEngine::UI::UiFactory::createCanvas(scene, "CanvasSinglePlayer");
        canvas->setActive(false);

        // Creation d'une image

        {
            auto backgroundImage = KapEngine::UI::UiFactory::createImage(scene, "Background");
            auto imageComp = std::make_shared<KapEngine::UI::Image>(backgroundImage);
            imageComp->setPathSprite("Assets/Textures/background_2.png");
            imageComp->setRectangle(KapEngine::Tools::Rectangle(0, 0, 755, 448));
            backgroundImage->addComponent(imageComp);

            auto& transform = backgroundImage->getComponent<KapEngine::Transform>();
        ...
        {
            auto buttonStart = scene.createGameObject("StartButton");
            auto playButtonComp = std::make_shared<KapEngine::UI::Button>(buttonStart, "Start");
            playButtonComp->setBackground("Assets/Textures/button.png", {5, 9, 655, 213});
            buttonStart->addComponent(playButtonComp);

            auto& transform = buttonStart->getComponent<KapEngine::Transform>();
            transform.setPosition(KapEngine::Tools::Vector3(449, 350, 0));
            transform.setScale(KapEngine::Tools::Vector3(222, 39, 0));
            playButtonComp->setTextPosition(KapEngine::Tools::Vector2(90, 12));
            playButtonComp->setTextColor(KapEngine::Tools::Color::white());
            transform.setParent(canvas);
        }

        // Creation d'un bouton pour revenir au menu
        {
            auto backButton = scene.createGameObject("BackButton");
            auto backButtonComp = std::make_shared<KapEngine::UI::Button>(backButton, "Back");
            backButtonComp->setBackground("Assets/Textures/button.png", {5, 9, 655, 213});
            backButton->addComponent(backButtonComp);

            auto& transform = backButton->getComponent<KapEngine::Transform>();
            transform.setPosition(KapEngine::Tools::Vector3(449, 400, 0));
            backButtonComp->setTextPosition(KapEngine::Tools::Vector2(90, 12));
            backButtonComp->setTextColor(KapEngine::Tools::Color::white());
            transform.setScale(KapEngine::Tools::Vector3(222, 39, 0));
            transform.setParent(canvas);
        }
        ...
        {
            auto usernameLabel = KapEngine::UI::UiFactory::createText(scene, "UsernameTextField");
            auto textComp = std::make_shared<KapEngine::UI::Text>(usernameLabel, "Username : ");
            usernameLabel->addComponent(textComp);

            auto& transform = usernameLabel->getComponent<KapEngine::Transform>();
        ...
        {
            auto usernameInputField = scene.createGameObject("Solo InputField");
            auto inputFieldComp = std::make_shared<KapEngine::UI::Inputfield>(usernameInputField);
            usernameInputField->addComponent(inputFieldComp);

            auto& transform = usernameInputField->getComponent<KapEngine::Transform>();
            transform.setScale(KapEngine::Tools::Vector3(150, 35, 0));
            transform.setPosition(KapEngine::Tools::Vector3(200, 100, 0));
            transform.setParent(canvas);
        }

        // Creation d'une animation Choose Ship
        {
            auto shipAnimation = scene.createGameObject("Animation Ship");
            manager.setSpaceshipSelection(shipAnimation);
            auto imageComp = std::make_shared<KapEngine::UI::Image>(shipAnimation);
            imageComp->setPathSprite("Assets/Textures/ship1.png");
            imageComp->setRectangle(KapEngine::Tools::Rectangle(0, 0, 263, 116));
            shipAnimation->addComponent(imageComp);

            auto& transform = shipAnimation->getComponent<KapEngine::Transform>();
            transform.setScale({132, 58, 0});
            transform.setPosition({200, 200, 0});
            transform.setParent(canvas);
            initShipAnimation(shipAnimation);
        }
...
void optionScene(KapEngine::KapEngine *engine)
{
    try {
        ...
        auto imgBg = KapEngine::UI::UiFactory::createImage(scene, "OptionBackground");
        ...
        auto buttonVolume = scene.createGameObject("VolumeButton");
        ...
        auto buttonKeyBoard = scene.createGameObject("KeyboardButton");
        ...
        auto buttonMenu = scene.createGameObject("OptionButton");
...
void createMenu(KapEngine::KapEngine *engine)
{
    try {
        ...
        auto imgBg = KapEngine::UI::UiFactory::createImage(scene, "Background");
        auto compImgBg = std::make_shared<KapEngine::UI::Image>(imgBg);
        ...
        auto imgTitle = KapEngine::UI::UiFactory::createImage(scene, "Title");
        ...
        auto buttonPlay = scene.createGameObject("PlayButton");
        ...
        auto buttonMulti = scene.createGameObject("MultiplayerButton");
        auto compButtonMulti = std::make_shared<KapEngine::UI::Button>(buttonMulti, "Multiplayer");
        ...
        auto buttonOpt = scene.createGameObject("OptionButton");
        ...
        auto buttonExit = scene.createGameObject("ExitButton");
...
int main(int ac, char **av)
{
    ...
    initWindow(&engine);
    try {
        engine.getSceneManager()->createScene("Solo");
        engine.getSceneManager()->createScene("Multi");
        // Creation du manager scene
        auto managerScene = engine.getSceneManager()->getScene(1).createGameObject("MenuManager");
