...
public:
  ...
  void drawText(std::string const &fontPath, std::string const &text, Vector2 pos, float fontSize, float spacing,
                Color col)
  {
  ...
  void drawTexture(std::string const &path, float posX, float posY, float width, float heigth, float rot,
